...
case 49:this.$ = $$[$0-1];
break;
case 50:this.$ = new t.FnExpr($$[$0-3], $$[$0-1]);
break;
case 51:this.$ = new t.ArithExpr('-', $$[$0-2], $$[$0]);
break;
case 52:this.$ = new t.ArithExpr('+', $$[$0-2], $$[$0]);
break;
case 53:this.$ = new t.ArithExpr('*', $$[$0-2], $$[$0]);
break;
case 54:this.$ = new t.ArithExpr('/', $$[$0-2], $$[$0]);
break;
case 55:this.$ = new t.CombExpr('AND', $$[$0-2], $$[$0]);
break;
case 56:this.$ = new t.CombExpr('OR', $$[$0-2], $$[$0]);
break;
case 57:this.$ = new t.CombExpr('ILIKE', $$[$0-2], $$[$0]);
break;
case 58:this.$ = new t.CombExpr('LIKE', $$[$0-2], $$[$0]);
break;
case 59:this.$ = new t.CombExpr('EQ', $$[$0-2], $$[$0]);
break;
case 60:this.$ = new t.CombExpr('IN', $$[$0-2], $$[$0]);
break;
